...
// Setup 装载
// endpoint sss
func (e *QiNiuKODO) Setup(endpoint, accessKeyID, accessKeySecret, bucketName string, domain string, options ...ClientOption) error {
...
func (e *QiNiuKODO) UpLoad(yourObjectName string, localFile interface{}) (*string, error) {
	...
	log.ZInfo(context.Background(), "success to upload file to qiniu kodo", "key", ret.Key, "hash", ret.Hash)
